...
// HOME PAGE
// =============================================================
// This is a normal React component used as a frontend page.
// It does not fetch data. It simply explains the project.
  ...
  return (
    <section className="card">
      ...
      <ul>
        ...
        <li>GET /api/mensajes</li>
        <li>POST /api/mensajes</li>
      </ul>

      <p>
        Main idea: React Router changes pages. Express sends and receives data.
      </p>
    </section>
  );
}
